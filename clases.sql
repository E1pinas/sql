-- --------------------------------------------------------
-- Host:                         localhost
-- Versión del servidor:         10.11.13-MariaDB - mariadb.org binary distribution
...
CREATE DATABASE IF NOT EXISTS `bd_aprendizaje` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `bd_aprendizaje`;
...
INSERT INTO `tb_articulos` (`codigo_articulos`, `descripcion_articulos`, `marca_articulo`, `fec_crea`, `codigo_unidad`, `codigo_categoria`) VALUES
	(1, 'ESCRITORIO', 'STANDARD', '2022-07-21', 1, 1),
	(2, 'SILLA', 'STANDARD', '2025-07-21', 1, 2);
...
-- Volcando datos para la tabla bd_aprendizaje.tb_categorias: ~5 rows (aproximadamente)
